...
const seedEvents = [
  ...
  {
    id: 'm1a1b2c3-d4e5-6f7a-8b9c-0d1e2f3a4b5c',
    title: 'Acoustic Unplugged Evening',
    description: 'An intimate candlelit acoustic session featuring indie singer-songwriters, soulful vocals, and warm rhythm arrangements.',
    category: 'Music',
    date: new Date(Date.now() + 6 * 24 * 60 * 60 * 1000).toISOString().split('T')[0],
    time: '19:30 - 22:00',
    venue: 'Skyline Amphitheater, Bengaluru',
    organizer: 'Soulful Tones',
  ...
  {
    id: 'm2b2c3d4-e5f6-7a8b-9c0d-1e2f3a4b5c6d',
    title: 'Symphony Orchestra Night',
    description: 'A grand classical concert with a 60-piece orchestra performing epic film scores, symphonies, and concertos.',
    category: 'Music',
    date: new Date(Date.now() + 18 * 24 * 60 * 60 * 1000).toISOString().split('T')[0],
    time: '19:00 - 21:30',
    venue: 'Royal Concert Hall, Chennai',
    organizer: 'Philharmonic Society',
    image_url: 'https://images.unsplash.com/photo-1465847899084-d164df4dedc6?auto=format&fit=crop&q=80&w=600',
    ticket_price: 999.00,
    is_approved: true,
    created_by: null,
  },
  {
    id: 'c1c2d3e4-f5a6-7b8c-9d0e-1f2a3b4c5d6e',
    title: 'Classical Bharatanatyam Showcase',
    description: 'An enchanting evening of classical Indian dance recitals featuring celebrated soloists and troupe performances.',
    category: 'Cultural',
    date: new Date(Date.now() + 9 * 24 * 60 * 60 * 1000).toISOString().split('T')[0],
    time: '18:00 - 20:30',
    venue: 'Kalakshetra Auditorium, Chennai',
    organizer: 'Natyakala Foundation',
  ...
  },
  {
    ...
    title: 'Grand Craft & Folk Art Carnival',
    description: 'Artisan handicraft stalls, live pottery making, traditional puppet shows, and regional folk music performances.',
    category: 'Cultural',
    date: new Date(Date.now() + 21 * 24 * 60 * 60 * 1000).toISOString().split('T')[0],
    time: '10:00 - 19:00',
    venue: 'Freedom Park Grounds, Bengaluru',
    organizer: 'Heritage Crafts Guild',
  ...
  {
    id: 'k1d2e3f4-a5b6-7c8d-9e0f-1a2b3c4d5e6f',
    title: 'Inter-College Battle of Bands',
    description: 'High-octane college rock and fusion bands competing live on stage for the regional championship title.',
    category: 'College',
    date: new Date(Date.now() + 11 * 24 * 60 * 60 * 1000).toISOString().split('T')[0],
    time: '16:00 - 22:00',
    venue: 'University Open Air Theater, Chennai',
    organizer: 'Youth Fest Committee',
    image_url: 'https://images.unsplash.com/photo-1498038432885-c6f3f1b912ee?auto=format&fit=crop&q=80&w=600',
    ticket_price: 100.00,
    is_approved: true,
    created_by: null,
  },
  {
    id: 's1e2f3a4-b5c6-7d8e-9f0a-1b2c3d4e5f6a',
    title: 'Night Turf 7v7 Football Cup',
    description: 'Floodlit 7-a-side football tournament under the stars. 32 teams fighting for the cash prize and trophy.',
    category: 'Sports',
    date: new Date(Date.now() + 7 * 24 * 60 * 60 * 1000).toISOString().split('T')[0],
    time: '18:00 - 02:00',
    venue: 'GameOn Sports Turf, Bengaluru',
    organizer: 'Turf Legends',
    image_url: 'https://images.unsplash.com/photo-1574629810360-7efbbe195018?auto=format&fit=crop&q=80&w=600',
    ticket_price: 200.00,
    is_approved: true,
    created_by: null,
  },
  {
    id: 's2f3a4b5-c6d7-8e9f-0a1b-2c3d4e5f6a7b',
    title: 'Midnight 10K Neon City Run',
    description: 'Glowing neon night marathon with live DJ music stations positioned along the scenic city beach road route.',
    category: 'Sports',
    date: new Date(Date.now() + 16 * 24 * 60 * 60 * 1000).toISOString().split('T')[0],
    time: '22:00 - 01:00',
    venue: 'Marina Beach Promenade, Chennai',
    organizer: 'City Runners Club',
    image_url: 'https://images.unsplash.com/photo-1452626038306-9aae5e071dd3?auto=format&fit=crop&q=80&w=600',
    ticket_price: 350.00,
    is_approved: true,
    created_by: null,
  },
  {
    ...
    title: 'Web3 & Cloud Architecture Summit',
    description: 'Deep dive technical keynotes on serverless computing, Kubernetes clusters, decentralized protocols, and cloud scaling.',
    category: 'Technology',
    date: new Date(Date.now() + 22 * 24 * 60 * 60 * 1000).toISOString().split('T')[0],
    time: '09:30 - 17:30',
    venue: 'NASSCOM IT Center, Bengaluru',
  ...
  },
  {
    ...
    title: 'Asian Street Food & Dumpling Carnival',
    description: 'Indulge in over 40 Asian street food stalls, live ramen bars, steamed dim sum, and boba tea tasting lounges.',
    category: 'Food Festival',
    date: new Date(Date.now() + 13 * 24 * 60 * 60 * 1000).toISOString().split('T')[0],
    time: '13:00 - 22:30',
    venue: 'Phoenix Marketcity Square, Chennai',
    organizer: 'Street Eats Guild',
  ...
  {
    id: 'w1c2d3e4-f5a6-7b8c-9d0e-1f2a3b4c5d6e',
    title: 'UI/UX Design & Micro-Interactions Workshop',
    description: 'Hands-on masterclass building responsive web components, glassmorphism design systems, and fluid animations.',
    category: 'Workshops',
    date: new Date(Date.now() + 17 * 24 * 60 * 60 * 1000).toISOString().split('T')[0],
    time: '10:00 - 16:00',
    venue: 'Design Studio Hub, Bengaluru',
    organizer: 'Pixel Perfect Guild',
    image_url: 'https://images.unsplash.com/photo-1581291518633-83b4ebd1d83e?auto=format&fit=crop&q=80&w=600',
    ticket_price: 750.00,
    is_approved: true,
    created_by: null,
  },
  {
    id: 'sem1d2e3-f4a5-6b7c-8d9e-0f1a2b3c4d5e',
    title: 'Future of EV & Green Mobility Conclave',
    description: 'Keynote panel with automotive leaders discussing electric vehicle battery innovations, charging infrastructure, and clean energy.',
    category: 'Seminar',
    date: new Date(Date.now() + 24 * 24 * 60 * 60 * 1000).toISOString().split('T')[0],
    time: '10:00 - 16:00',
    venue: 'World Trade Center Convention Hall, Bengaluru',
    organizer: 'Green Tech India',
    image_url: 'https://images.unsplash.com/photo-1558441719-674508073756?auto=format&fit=crop&q=80&w=600',
    ticket_price: 0.00,
    is_approved: true,
    created_by: null,
  },
  {
    ...
    description: 'An open-air classical orchestral concert featuring masterpiece compositions, live violin solos, and a grand grand finale performance under the night sky.',
    category: 'Music',
    date: new Date(Date.now() + 18 * 24 * 60 * 60 * 1000).toISOString().split('T')[0],
    time: '19:00 - 22:30',
    venue: 'Royal Botanical Amphitheatre, Bengaluru',
    organizer: 'Philharmonic Society',
    image_url: 'https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?auto=format&fit=crop&q=80&w=600',
    ticket_price: 899.00,
    is_approved: true,
  ...
  },
  {
    ...
    title: 'International Folk & Dance Carnival',
    description: 'Immerse yourself in global rhythms, traditional costumes, live folk instrumentalists, and interactive dance workshops representing 15 countries.',
    category: 'Cultural',
    date: new Date(Date.now() + 22 * 24 * 60 * 60 * 1000).toISOString().split('T')[0],
    time: '11:00 - 21:00',
    venue: 'Heritage City Pavilion, Mysuru',
    organizer: 'Global Folk Alliance',
  ...
  },
  {
    ...
    title: 'TechXplore Inter-College Battle',
    description: 'Colleges battle in robotics wars, speed coding, gaming tournaments, and paper presentations for the prestigious Innovation Trophy.',
    category: 'College',
    date: new Date(Date.now() + 16 * 24 * 60 * 60 * 1000).toISOString().split('T')[0],
    time: '08:30 - 17:30',
    venue: 'Engineering College Campus, Chennai',
    organizer: 'Student Engineering Council',
  ...
  },
  {
    ...
    title: 'Premier Night Marathon & Fitness Expo',
    description: 'Run under the neon city lights! Includes 5K Fun Run, 10K Challenge, Half Marathon, and a massive post-race fitness concert.',
    category: 'Sports',
    date: new Date(Date.now() + 28 * 24 * 60 * 60 * 1000).toISOString().split('T')[0],
    time: '20:00 - 01:00',
    venue: 'City Marina Boulevard, Chennai',
    organizer: 'Runners Club India',
    image_url: 'https://images.unsplash.com/photo-1452626038306-9aae5e071dd3?auto=format&fit=crop&q=80&w=600',
    ticket_price: 499.00,
    is_approved: true,
    created_by: null,
  },
  {
    ...
    title: 'Asian Street Eats & BBQ Night',
    description: 'Savor live sizzling teppanyaki, Korean BBQ, authentic momos, matcha desserts, and Asian craft beverages by master street chefs.',
    category: 'Food Festival',
    date: new Date(Date.now() + 12 * 24 * 60 * 60 * 1000).toISOString().split('T')[0],
    time: '17:00 - 23:00',
    venue: 'Downtown Night Market Square, Bengaluru',
    organizer: 'Street Food Society',
    image_url: 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?auto=format&fit=crop&q=80&w=600',
    ticket_price: 200.00,
    is_approved: true,
    created_by: null,
